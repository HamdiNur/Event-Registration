        ...
        <div className="grid grid-cols-4 gap-4 mb-8">
          {[
            ...
            },
            {
              ...
              value: events.reduce((acc, e) => acc + e._count.registrations, 0),
            },
          ].map((stat) => (
            <div
              key={stat.label}
                ...
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex-1 p-6">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span
                        className={`text-xs font-semibold px-2 py-1 rounded-full ${getStatusColor(event.status)}`}
                      >
                        {event.status}
                      </span>
                    </div>
                  ...
                  {/* Actions */}
                  <div className="flex items-center gap-2 p-6 pl-0">
                    <Link
                      href={`/organizer/attendees/${event.id}`}
